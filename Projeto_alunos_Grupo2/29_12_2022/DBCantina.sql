...
-- A despejar dados para tabela dbcantina.admin: ~7 rows (aproximadamente)
...
INSERT INTO `admin` (`id_admin`, `Nome`, `Login`, `Password`, `Tipo_admin_id_tipoadmin`, `Estado_atividade_idEstado_atividade`) VALUES
	...
	(3, '', 'Paulo', '999888777', 2, 0),
	(4, '', 'Tiago', '111222333', 1, 1),
	(5, '', 'Fernando', '987456321', 1, 1),
	(6, '', 'Sofia', 'coisasdegaja', 1, 1),
	(7, '', 'Boss', 'BigBoss', 1, 1),
	(8, '', 'Boss2', 'BigBoss2', 2, 1);
...
-- A despejar dados para tabela dbcantina.ementa: ~8 rows (aproximadamente)
/*!40000 ALTER TABLE `ementa` DISABLE KEYS */;
INSERT INTO `ementa` (`idEmenta`, `sopa`, `carne`, `peixe`, `veg`, `sobremesa`) VALUES
	(1, 'Sopa de Feojao', 'Feijoada', 'Peixe com Feijao', 'Feijao', 'humus'),
...
-- A despejar dados para tabela dbcantina.formando: ~7 rows (aproximadamente)
/*!40000 ALTER TABLE `formando` DISABLE KEYS */;
INSERT INTO `formando` (`idFormando`, `NIF`, `Nome`, `Tipo_Residencia_idTipo_Residencia`, `Estado_atividade_idEstado_atividade`) VALUES
	(1, 123456789, 'Henrique', 1, 1),
	(2, 987654321, 'Joaquim', 0, 0),
	(3, 123654789, 'Maria', 1, 1),
	(4, 321456789, 'Telmo', 1, 1),
	(5, 456222111, 'Jesualdo', 0, 1),
	(6, 111999888, 'Matias', 0, 0),
	(7, 444555666, 'Timoteo', 0, 1);
...
-- A despejar dados para tabela dbcantina.tipo_admin: ~2 rows (aproximadamente)
...
-- A despejar dados para tabela dbcantina.turma: ~3 rows (aproximadamente)
/*!40000 ALTER TABLE `turma` DISABLE KEYS */;
INSERT INTO `turma` (`idTurma`, `data_inicio`, `data_fim`, `descricao`) VALUES
	(1, '2023-01-02 14:45:47', '2024-01-02 14:45:54', 'Técnico de Programacao'),
	(2, '2024-01-02 16:05:50', '2025-01-02 16:05:51', 'Técnico de Multimedia'),
	(3, '2025-01-02 16:06:12', '2025-01-02 16:06:16', 'Técnico de Ceramica'),
	(4, '2000-01-02 13:07:19', '2022-01-02 16:07:29', 'Técnico de Tecnicidades');
...
-- A despejar dados para tabela dbcantina.turma_has_formando: ~7 rows (aproximadamente)
