...
INSERT INTO `formando` (`idFormando`, `Nome`, `Email`, `NIF`, `Tipo_Residencia_idTipo_Residencia`, `Estado_atividade_idEstado_atividade`) VALUES
	...
	(20670, 'Tânia Filipa António', 'email@cencal.pt', 321654999, 0, 1),
	(31310, 'João Roberto Da Conceição Nogueira', 'email@cencal.pt', 321654994, 0, 1),
	(32062, 'Henrique Boita Ferreira Paulo', 'EUMOROAQUI', 321654992, 1, 1),
	...
	(36402, 'Vítor Daniel Gomes Querido', 'qualquermerdaporfavor@hotmailamos.com', 321655001, 0, 1),
...
INSERT INTO `turma` (`idTurma`, `data_inicio`, `data_fim`, `descricao`, `cod_curso`) VALUES
	...
	(7, '2022-05-02', '2025-02-25', 'programa', '481TI827.22');
...
-- A despejar dados para tabela dbcantina.turma_has_formando: ~8 rows (aproximadamente)
